<template>
    <div class="internationalconference">
        ...
        <li v-for="(qualification, index) in qualifications" :key="index">
          <template v-if="editMode">
            <div v-if="selectedOption === 'fill'">
              ...
              <input type="text" v-model="qualification.journalname" class="edit-input" placeholder="Journal name" />
              <input type="text" v-model="qualification.published" class="edit_input" placeholder="publisher"/>
              ...
              <input type="text" v-model="qualification.impact" class="edit-input" placeholder="Impact Factor" />
  ...
  export default {
    ...
    data() {
      return {
        editMode: false,
        qualifications: [{ author_name: 'Ansuman Mahapatra,', title: 'MOHASA: A Dynamic Video Synopsis Approach for Consumer-based Spherical Surveillance Video', journalname: 'IEEE Transactions on Consumer Electronics', published: 'IEEE', venue:'Rajasthan', date: new Date(2023,0,1), vol: '200', vol_no: '500',page_no: '25',issue: '20', indexing: '22',impact :'4.3', dol_link: 'link' },],
    ...
    methods: {
      ...
      addQualification() {
        if (this.editMode && this.selectedOption === 'fill') {
          this.qualifications.push({ author_name: '', title: '', journalname: '', published: '',venue :'', date: new  Date(),vol:'', vol_no:'',page_no:'',indexing:'',dol_link:'' });
        }
      },
      ...
      clearPlaceholder(index) {
        ...
        this.qualifications[index].journalname = '';
