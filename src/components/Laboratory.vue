<template>
    <div class="laboratory">
      <div class="header-container">
        <h2 class="heading">Laboratory Developed</h2>
        <div class="buttons">
  ...
  export default {
    ...
    methods: {
      async toggleEditMode() {
        ...
        if (area._id) {
          return axios.delete(`http://localhost:3000/Laboratory/${area._id}`);
        }
    ...
    async deletearea(areaId) {
      try {
        await axios.delete(`http://localhost:3000/Laboratory/${areaId}`);
